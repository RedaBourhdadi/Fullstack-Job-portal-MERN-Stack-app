...
import DashCreateUserMe from './pages/admin/DashCreateUserMe';
...
const DashCreateUserMeHOC = Layout(DashCreateUserMe)
                ...
                <ProSidebarProvider>
                    <BrowserRouter>
                        <Routes>
                            ...
                            <Route path='/admin/User/create' element={<AdminRoute><DashCreateUserMeHOC /></AdminRoute>} />
